      ...
      <div id="navWrapper">
        <nav>
          ...
          <div id="icon-button">
            ...
            <a id="menu-list-item" onClick={onHeartToggleClick}>
              <span>
                <svg
                  aria-label="활동 피드"
                  id="nav-heart"
            ...
            {heartToggle ? <Activity /> : null}
            <h4 className="blind">User</h4>
            <a onClick={onUserToggleClick}>
              <span>
                {me?.UserProfileImage ? (
                  <Avatar size={25} icon={<img className="my-img" src={me.UserProfileImage[0]} />} />
                ) : (
