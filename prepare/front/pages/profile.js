              ...
              <div id="profile-user-info">
                <div id="mobile-profile-user-info">
                  <div className="profile-title">
                    <h1>kyh0506_</h1>
                    <button className="profile-all-btn">프로필 편집</button>
                    <div>
                  ...
                  <button id="profile-mobile-btn">프로필 편집</button>
                </div>
                ...
                <div className="profile-post-follow">
                  ...
                  <span>
                    팔로워 <span className="count">0</span>
                  </span>
                  <span>
                    팔로우 <span className="count">0</span>
                  </span>
                </div>
